...
public class WaveFileManager {
     ...
     * @param wave the WAV object
     * @throws IOException IO Exception
     * 
     */
    public static void save(String filename, Wave wave) throws IOException {
     ...
     */
    public static void save(OutputStream fos, Wave wave) throws IOException {
