...
public class FingerprintSimilarity {
    ...
    /**
     * Get the similarity of the fingerprints similarity from 0~1, which 0 means
     * no similar feature is found and 1 means in average there is at least one
     * match in every frame
     * 
     * @return similarity
     */
    ...
    /**
     * Get the similarity score of the fingerprints Number of features found in
     * the fingerprints per frame
     * 
    ...
    public float getsetMostSimilarTimePosition() {
        return (float) mostSimilarFramePosition
                / fingerprintProperties.getNumRobustPointsPerFrame()
