...
public class RobustIntensityProcessor implements IntensityProcessor {
    ...
    /**
     * @param intensities
     * @param numPointsPerFrame
     */
    public RobustIntensityProcessor(double[][] intensities,
    ...
    public void execute() {
        ...
        for (int i = 0; i < numX; i++) {
            ...
            double passValue = arrayRankDouble.getNthOrderedValue(tmpArray,
                    numPointsPerFrame, false);
