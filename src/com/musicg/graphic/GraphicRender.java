...
public class GraphicRender {
     ...
     *            Wave object
     * @param timeStep
     *            time interval in second, as known as 1/fps
     * @param filename
     *            output file
     */
     ...
     *            spectrogramData[time][frequency]=intensity, which time is the
     *            x-axis, frequency is the y-axis, intensity is the color
     *            darkness
     * @param filename
     *            output file
     */
            ...
            for (int i = 0; i < width; i++) {
                if (i == xMarker) {
                    ...
                    for (int j = 0; j < height; j++) {
                        ...
                        bufferedImage.setRGB(i, height - 1 - j, value << 16
                                | value << 8 | value);
                    }
                }
            }
