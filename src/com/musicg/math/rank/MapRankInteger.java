...
public class MapRankInteger {
    ...
    public List<Integer> getOrderedKeyList(int numKeys, boolean sharpLimit) {
        ...
        if (map.size() > 0) {
            ...
            // get the pass values
            Iterator<Entry<Integer, Integer>> mapIterator = mapEntrySet.iterator();
            ...
            int passValue = getOrderedValue(array, targetindex); // this value
                                                                 // is the value
                                                                 // of the
                                                                 // numKey-th
                                                                 // element
            ...
            while (true) {
                ...
                Iterator<Entry> passedMapIterator = passedMap.entrySet()
                        .iterator();
