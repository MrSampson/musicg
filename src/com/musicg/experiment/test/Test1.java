...
public class Test1 {
    ...
    public static void main(String[] args) {
        ...
        int overlapFactor = 1;
        Spectrogram spectrogram = new Spectrogram(wave, fftSampleSize,
                overlapFactor);
        ...
        double[][] absoluteSpectrogramData = spectrogram
        ...
        for (int i = 0; i < spectrogramData.length; i++) {
            ...
            System.arraycopy(spectrogramData[i], lowerBoundary, temp, 0,
                    temp.length);
            ...
            System.out.println(i + " " + (double) i / fps + "s\t" + maxIndex
                    + "\t" + sdValue + "\t" + zcrs[i]);
        ...
        for (int frame = 0; frame < absoluteSpectrogramData.length; frame++) {
            ...
            if (sdValue < passSd) {
                System.arraycopy(spectrogramData[frame], lowerBoundary, temp,
                        0, temp.length);
                double maxFrequency = arrayRankDouble.getMaxValueIndex(temp)
                        * unitFrequency;
                ...
                double nthValue = arrayRankDouble.getNthOrderedValue(temp,
                        numRobust, false);
                int count = 0;
                ...
                System.out.print(" intensity: " + intensity + " pitch: "
                        + maxFrequency);
