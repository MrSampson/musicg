...
/**
 * Construct new data points within the range of a discrete set of known data
 * points by linear equation
 * 
 * @author Jacquet Wong
 */
public class LinearInterpolation {
    ...
    /**
     * Do interpolation on the samples according to the original and destinated
     * sample rates
     * 
     * @param oldSampleRate
     *            sample rate of the original samples
     * @param newSampleRate
     *            sample rate of the interpolated samples
     * @param samples
     *            original samples
    ...
    public static short[] interpolate(int oldSampleRate, int newSampleRate,
        ...
        for (int i = 0; i < newLength; i++) {
            ...
            float slope = samples[nearestRightPosition]
                    - samples[nearestLeftPosition]; // delta x is 1
